...
def get_prop_address(): 
    ...
    try:
        ...
        prop_address_list.append(address)
        
    except:
        address = '*** no value found ***'
        prop_address_list.append(address)
    finally:
        print(prop_address_list)
...
def get_prop_date_entered():
    ...
    try:
        ...
        date_entered_list.append(date_entered)
...
def get_prop_description():
    ...
    try:
        ...
        prop_desc_list.append(property_description)
    except:
...
def get_prop_lat_long():
    ...
    try:
        ...
        # print(latitude_long)
        prop_lat_long_list.append(latitude_long)
    except:
...
def get_prop_main_photo():
    ...
    try:
        ...
        prop_main_photo_list.append(main_photo)
...
def create_dataframe_from_lists():
    ...
    while countUUID < len(prop_main_photo_list): #this can be any of the lists
    ...
    dict_for_df = { 
        ...
        'Address':prop_address_list,
        'Type':prop_type_list,
        'Price':prop_price_list,
        'Beds':prop_beds_list,
        'Baths':prop_baths_list,
        'Description':prop_desc_list,
        'Latitude_Longitude':prop_lat_long_list,
        'Advert_Views':views_list,
        'Date_Entered':date_entered_list,
        'Main Photo': prop_main_photo_list
    }
